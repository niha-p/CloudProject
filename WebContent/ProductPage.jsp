...
<body>
	...
	<div class="container" id="container" style="padding-top:20px">
		...
		<div class="row">
			...
			<article class="col-md-8 maincontent">
				...
				<h6>Seller: <c:out value="${uname}"></c:out></h6>
				<p><c:out value="${desc}"></c:out></p>
				<h2>$ <c:out value="${price}"></c:out></h2>
				<blockquote>
				<input type="hidden" id="address" value="<c:out value="${address}"></c:out>,<c:out value="${city}"></c:out>,<c:out value="${zip}"></c:out>">
				<c:out value="${address}"></c:out>, <c:out value="${city}"></c:out>, <c:out value="${zip}"></c:out>
				</input></blockquote>
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=ADDYOURKEYHERE&signed_in=true&callback=initMap"
	        async defer></script>
